        ...
        this.streamTrack = function (trackResolvable) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        client_id = _a.sent();
                        return [2 /*return*/, axios_1["default"].get(track.download_url, { responseType: "stream", params: { client_id: client_id, oauth_token: this.api.oauthToken } })];
        ...
        this.downloadSongCover = function (trackResolvable, dest, noDL) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        client_id = _a.sent();
                        url = artwork + "?client_id=" + client_id;
                        if (noDL)
                            return [2 /*return*/, url];
                        return [4 /*yield*/, axios_1["default"].get(url, { responseType: "arraybuffer" }).then(function (r) { return r.data; })];
                    case 5:
                        arrayBuffer = _a.sent();
